const puzzle = {
  prompt: "Complete the puzzle by filling in the missing letters to uncover the riddle. Can you guess what I am?",
  answer: "chicken",
};
...
function submitAnswer() {
  ...
  if (userAnswer === puzzle.answer.toLowerCase()) {
      ...
      setTimeout(() => {
          window.location.href = '/riddle-8/riddle-8.html'; // Update with the actual path to the next riddle
      }, 2000);
  } else {
...
function navigate(direction) {
  if (direction === 'left') {
    ...
    window.location.href = '/riddle-8/riddle-8.html'; // Update with the actual path
  }
}
