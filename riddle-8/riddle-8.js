const puzzle = {
  prompt: "What did the rebus puzzle lead you to?",
  answer: "camera",
};
...
function submitAnswer() {
  ...
  if (userAnswer === puzzle.answer.toLowerCase()) {
    ...
    setTimeout(() => {
      window.location.href = '/Completion-Page/completion.html'; // Update with the actual path to the next riddle
    }, 2000);
  } else {
...
function navigate(direction) {
  if (direction === 'left') {
    ...
    window.location.href = '/riddle-6/riddle-6.html'; // Update with the actual path
  }
}
