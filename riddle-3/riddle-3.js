...
function submitAnswer() {
  ...
  if (userAnswer === puzzle.answer.toLowerCase()) {
      ...
      setTimeout(() => {
          window.location.href = '/riddle-4/riddle-4.html'; // Update with the actual path to the next riddle
      }, 2000);
  } else {
...
function navigate(direction) {
  if (direction === 'left') {
    ...
    window.location.href = '/riddle-4/riddle-4.html'; // Update with the actual path
  }
}
